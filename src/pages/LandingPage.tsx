...
import { ArrowRight, Brain, GitBranch, BarChart3, Sparkles, Zap, Shield, Sun, Moon } from "lucide-react";
...
const features = [
  { icon: Brain, title: "Decision Simulation", description: "Generate multiple future scenarios from a single decision to explore every possible path.", color: "text-primary", bg: "bg-primary/10" },
  { icon: GitBranch, title: "Scenario Modeling", description: "Compare branching outcomes side by side with risk levels, growth potential, and timelines.", color: "text-accent", bg: "bg-accent/10" },
  { icon: BarChart3, title: "Future Timelines", description: "Visualize how your decisions unfold over months and years with structured timelines.", color: "text-sky", bg: "bg-sky/10" },
  { icon: Sparkles, title: "AI Strategic Advisor", description: "Get structured insights about opportunities, risks, and required effort for each path.", color: "text-warm", bg: "bg-warm/10" },
  { icon: Zap, title: "Instant Analysis", description: "Receive comprehensive decision intelligence in seconds, not hours of research.", color: "text-rose", bg: "bg-rose/10" },
  { icon: Shield, title: "Risk Assessment", description: "Understand potential pitfalls and challenges before committing to any direction.", color: "text-primary", bg: "bg-primary/10" },
];
    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="py-32 relative z-10">
        <div className="container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="glass rounded-3xl p-12 sm:p-16 max-w-3xl mx-auto glow-primary">
